          ...
          {eBooks.map((ebook) => (
            ...
            >
              <div className="relative h-48">
                <div className={`absolute inset-0 ${ebook.color} rounded-lg`} />
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-sm text-mauve-700">{ebook.rating.toFixed(1)} ({ebook.reviews} reviews)</span>
                  </div>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    <div className="relative w-12 h-12 bg-plum-900 rounded-full" />
                    <div>
